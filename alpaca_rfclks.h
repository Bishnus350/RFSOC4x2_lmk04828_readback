 ...
 * not have a second RF ADC LMX PLL, the ZCU111 does, this is I3A for the ZCU111
...
//int prog_pll(spi_dev_t *dev, uint8_t spi_sdosel, uint32_t* buf, uint16_t len, uint8_t pkt_len);
...
// TODO: may be worth while having a more general readback structure and it
// seems like it could be cool to have a struct for the pll that had a pointer
// to the readback method, but that seems like a lot of work to implement now
// and so just hardcoding most readback methods
